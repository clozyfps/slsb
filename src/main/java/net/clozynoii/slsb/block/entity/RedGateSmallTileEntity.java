...
public class RedGateSmallTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public RedGateSmallTileEntity(BlockPos pos, BlockState state) {
		super(SlsbModBlockEntities.RED_GATE_SMALL.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<RedGateSmallTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<RedGateSmallTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("red_gate_small");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Red Gate Small");
	}
